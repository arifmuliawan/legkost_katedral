...
?>    
  ...
  flex-direction: column;">
                                    ...
                                    <li class="nav-item <?php echo $drop_com ?>">
                                        ...
                                        <ul class="nav nav-treeview" style="display: <?php echo $disp_com ?>;">
                                            ...
                                            ?>    
                                                    <li class="nav-item">
                                                        <?php
                                                        if(preg_match("/$file_submenu/i", $page))
                                                        {
                                                            $act_submenu = "active";
            ...
            <!-- Sidebar -->
            <div class="sidebar-footer" style="text-align: center;margin-bottom: 20px;">
                <strong style="color: #fff;">Developed By Designata Studio</strong>
            </div>
        </aside>