                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>    
                                            ...
                                            &nbsp&nbsp&nbsp
                                            <button id="btncreplacekregisimg" type="button" class="btn" style="background-color:#E90000;color: #ffffff;font-weight: bold;display: none;" onclick="return confirm('Are you sure you want to cancel this process ?')">CANCEL</button>
                                            <br>
                                        <?php
                                        }
                                        else
