                        ...
                        <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row" id=list-paroki>
                                    ...
                                    ?>
                                            <div class="col-12 col-sm-6 col-md-3 d-flex align-items-stretch flex-column" id="<?php echo $sortid_paroki ?>" data-id="<?php echo $id_paroki ?>" data-sec="<?php echo $sortid_paroki ?>">
