                                            ...
                                            <div class="row">
                                                ...
                                                ?>  
                                                        <div class="col-md-2" style="margin: 10px;cursor: grab;" id="<?php echo $sortid_staff ?>" data-id="<?php echo $id_staff ?>" data-sec="<?php echo $sortid_staff ?>">
                                                            <img class="datastaff" src="<?php echo $photo_staff ?>" style="width:150px;" data-toggle="modal" data-target="#updateparokimodal" data-staff='<?php echo json_encode($data_json) ?>'>
