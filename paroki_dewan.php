                                            ...
                                            <div class="col-md-3" id="<?php echo $sortid_paroki ?>" data-id="<?php echo $id_paroki ?>" data-sec="<?php echo $sortid_paroki ?>">
                                                <div class="card bg-light d-flex flex-fill">
                                                    ...
                                                    <div class="card-footer" style="text-align:right">
                                                        ...
                                                        <button id="btndeleteparoki" type="button" style="background-color:#E90000;color: #ffffff;font-weight: bold;" class="btn-sm" onclick="return confirm('Are you sure you want to delete this data ?')" data-paroki-2='<?php echo json_encode($paroki_json) ?>'><i class="nav-icon fas fa-trash"></i></button>
                                                    </div>
                                                </div>
                                            </div>        
                                    <?php
